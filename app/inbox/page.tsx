            ...
            <MainLayout>
                <div className="sm:mt-[80px] w-full sm:max-w-[calc(100vw-80px)] lg:max-w-[calc(100vw-250px)]  ml-auto sm:px-12 ">
                    <section className="flex flex-col w-full">
                        <nav className="flex items-center justify-between w-full p-4 sm:p-2 sm:border sm:rounded-full">
                            <button className="sm:bg-[#D3427A] sm:rounded-full sm:p-1"> <AiOutlineUsergroupAdd className="sm:text-white" onClick={toggleModal} size={28} /> </button>
                            ...
                            {/* <button className="sm:border sm:p-1 sm:rounded-full sm:shadow-xl sm:hover:bg-[#D3427A] group"> <IoIosSearch className="sm:group-hover:text-white" size={28} /> </button> */}
                        </nav>
                        <div className="grow mt-0 bg-[#181818] sm:bg-inherit relative">
                            {
                                !contextUser?.user &&
                            ...
                            <Modal isOpen={isModalOpen} onClose={toggleModal} customClassName="sm:static sm:mt-2 sm:w-full sm:shadow-3xl sm:border sm:overflow-hidden">
                                <CreateChat fetchConversations={fetchConversations} toggleModal={toggleModal} />
                            </Modal>
                            {!isModalOpen &&
                                <div className="divide-y divide-gray-400 sm:mt-4">
                                    {
